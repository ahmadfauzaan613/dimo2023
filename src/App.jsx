    ...
    <Provider store={store}>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/admin/penawaran" element={<LayoutAdmin><Penawaran /></LayoutAdmin>} />
          <Route path="/admin/pengalaman" element={<LayoutAdmin><Pengalaman /></LayoutAdmin>} />
          <Route path="/admin/portofolio" element={<LayoutAdmin><Portofolio /></LayoutAdmin>} />
          <Route path="/admin/user" element={<LayoutAdmin><User /></LayoutAdmin>} />
          <Route path="/" element={<LayoutUser><Home /></LayoutUser>} />
          <Route path="/pengalaman" element={<LayoutUser><PengalamanUser /></LayoutUser>} />
          <Route path="/struktur-organisasi" element={<LayoutUser><Struktur /></LayoutUser>} />
          <Route path="/portofolio" element={<LayoutUser><PortofolioUser /></LayoutUser>} />
